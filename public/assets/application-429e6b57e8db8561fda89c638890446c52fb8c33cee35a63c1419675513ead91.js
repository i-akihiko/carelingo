...
(function($){
  ...
  function _open(dropdown, speed){
    ...
    // added
    $(".easy-select-box, .esb-displayer").css("background", "url('/assets/caret_big_up-44722986dea2c4bdb8aeb1dfe222272d5f7827e0bae27e2043b939bbff35d28f.png') no-repeat 98%");
  }
  function _close(dropdown, speed){
    dropdown.slideUp(speed);
    // added
    $(".easy-select-box, .esb-displayer").css("background", "url('/assets/caret_big_down-a2efab79d101187688e8e44d51edfd2df0530115f91d11dcb6c2485d0f4f79b3.png') no-repeat 98%");
  }
  function _focusin(e){
    var easySelect = $(this);//$(this) refers to easySelect element
    var easySelectData = easySelect.data('easySelectData');
  ...
  function _updateSelect(selectObj, index) {
    ...
    // added
    if (index != 0) {
      $(".image_agreement_2").css("height", "233px");
    }
  }
...
(function() {
  var get_locale_param, get_locale_param_choose, get_url_param_with_key;
  ...
  $(document).on("page:change", function() {
    ...
    $(".form_sort_by").change(function() {
      var locale;
      console.log(this.value);
      locale = get_locale_param();
      return location.href = ("/" + locale) + ("/medicines/list?sort_by=" + this.value);
    });
    $(".medicine-list_table-cell").click(function() {
      var locale, medicine_id;
      console.log(parseInt($(this).find(".cell-medicine-id").text()));
      medicine_id = parseInt($(this).find(".cell-medicine-id").text());
      locale = get_locale_param();
      return location.href = ("/" + locale) + ("/medicines/" + medicine_id + "/choose");
    });
    $(".button_question").click(function() {
      var explanation, header, margin;
      ...
      if (explanation.css("display") === "none") {
        ...
        return header.css("margin-bottom", margin + "px");
      } else {
    ...
    $(".medicine_choose_button_bottom").click(function() {
      var locale, medicine_id, obj, params, path_comps;
      ...
      return location.href = ("/" + locale) + "/medicines/note?" + params;
    });
    return $(".show_note").click(function() {
      if ($(".note_my_language").css("display") === "none") {
        $(".note_english").css("display", "none");
        $(".note_my_language").css("display", "block");
        return $(".show_note").text($(".show_note").attr("show_note_in") + " (English)");
      } else {
        $(".note_english").css("display", "block");
        $(".note_my_language").css("display", "none");
        return $(".show_note").text($(".show_note").attr("show_note_in") + " (" + ($(".show_note").attr("language_name")) + ")");
      }
    });
  });

  get_url_param_with_key = function(key) {
    var h, hash, hashes, i, len;
  ...
  get_locale_param_choose = function() {
    var dirs;
    dirs = window.location.href.split("/");
    return dirs[dirs.length - 4];
  };

  get_locale_param = function() {
    var dirs;
    dirs = window.location.href.split("/");
...
(function() {
  var get_locale_param;

  $(document).on("page:change", function() {
    $(".hood_selection_entry a").click(function() {
      if (this.getAttribute("class").indexOf("adult") === -1) {
        $('.age_selection_entry').css("display", "block");
        $('.child').addClass("hood_selected");
        return $('.adult').removeClass("hood_selected");
      } else {
        $('.age_selection_entry').css("display", "none");
        $('.child').removeClass("hood_selected");
        return $('.adult').addClass("hood_selected");
      }
    });
    $(".pain_slider").change(function() {
      $(".pain_value").text(this.value);
      if (parseInt(this.value) === 10) {
        return $(".warning_entry").css("display", "block");
      } else {
        return $(".warning_entry").css("display", "none");
      }
    });
    return $(".patient_entry_button_bottom").click(function() {
      var age, elem, feel_like_ids, i, is_adult, j, locale, max, obj, pain, params, ref;
      ...
      params = $.param(obj);
      locale = get_locale_param();
      return location.href = ("/" + locale) + "/medicines/list?" + params;
    });
  });
...
(function() {
  ...
  $(document).on("page:change", function() {
    ...
    $(".form_language").change(function() {
      ...
      locale = this.value;
      return location.href = ("/" + locale) + "/symptoms/select";
    });
    $(".esb-item").click(function() {
      return $(".button_bottom").removeClass("disabled");
    });
    return $(".symptom_button_bottom").click(function() {
      var language_id, locale, location_id, obj, params, symptom_id;
      ...
      params = $.param(obj);
      locale = get_locale_param();
      return location.href = ("/" + locale) + "/patients/entry?" + params;
    });
  });
