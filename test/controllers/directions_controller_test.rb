...
class DirectionsControllerTest < ActionController::TestCase
  ...
  test "should create direction" do
    assert_difference('Direction.count') do
      post :create, direction: { over_12: @direction.over_12, over_6: @direction.over_6, under_6: @direction.under_6 }
    end
  ...
  test "should update direction" do
    patch :update, id: @direction, direction: { over_12: @direction.over_12, over_6: @direction.over_6, under_6: @direction.under_6 }
    assert_redirected_to direction_path(assigns(:direction))
  end
