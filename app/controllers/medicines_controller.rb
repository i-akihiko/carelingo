class MedicinesController < ApplicationController
  ...
  def note
    ...
    @language_name = Language.where(locale: params[:locale]).last.name
  end
  ...
  private
    ...
    def medicine_params
      params.require(:medicine).permit(:name, :min_price, :max_price, :description, :image_url, :size)
    end
end
